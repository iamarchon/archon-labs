        ...
        {success ? (
          ...
          <div style={{ textAlign: "center", padding: "6px 0" }}>
            ...
            <div style={{ color: T.inkSub, fontSize: "15px", marginBottom: "20px" }}>
              You {success.action.toLowerCase() === "buy" ? "bought" : "sold"} {success.shares} share{success.shares > 1 ? "s" : ""} of <span style={{ fontWeight: 600, color: T.ink }}>{stock.ticker}</span> at ${price.toFixed(2)}
            </div>
          ...
          <>
            ...
            <button
              onClick={() => { if (canAfford) onTrade(stock, action, shares); }}
              disabled={!canAfford}
