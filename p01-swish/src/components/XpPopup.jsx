...
export default function XpPopup({ xp = 0, level = "Bronze", onClose }) {
  ...
  return (
    <div ref={ref} style={{
      ...
      width: "320px", background: "#1a1a1a", borderRadius: "18px",
      boxShadow: "0 16px 48px rgba(0,0,0,.3)", padding: "24px",
      zIndex: 150, animation: "sheetUp .22s cubic-bezier(.34,1.56,.64,1)",
    }}>
      {/* Arrow */}
      <div style={{ position: "absolute", top: "-6px", right: "24px", width: "12px", height: "12px", background: "#1a1a1a", transform: "rotate(45deg)", borderRadius: "2px" }} />

      {/* Current level */}
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <div style={{ fontSize: "36px", marginBottom: "4px" }}>{LEVELS[currentIdx]?.emoji}</div>
        <div style={{ color: T.white, fontSize: "20px", fontWeight: 700, letterSpacing: "-0.4px" }}>{level}</div>
        <div style={{ color: T.white, fontSize: "28px", fontWeight: 700, letterSpacing: "-0.8px", marginTop: "4px", fontVariantNumeric: "tabular-nums" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ color: "rgba(255,255,255,.5)", fontSize: "12px", marginTop: "6px", textAlign: "center" }}>
        ...
        {LEVELS.map((l, i) => {
          ...
          return (
            <div key={l.name} style={{
              ...
              background: isCurrent ? `${T.accent}20` : "transparent",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <span style={{ color: isCurrent ? T.accent : T.white, fontSize: "14px", fontWeight: isCurrent ? 600 : 400 }}>
                  {l.name}
                </span>
              </div>
              <span style={{ color: "rgba(255,255,255,.4)", fontSize: "12px", fontWeight: 500, fontVariantNumeric: "tabular-nums" }}>
      ...
      <div style={{ color: "rgba(255,255,255,.35)", fontSize: "12px", textAlign: "center", marginTop: "16px" }}>
